# Generated by Django 3.0 on 2019-12-04 17:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Data for authenticate user',
                'verbose_name_plural': 'Data for authenticate users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_article', models.PositiveSmallIntegerField(default=0, verbose_name='number article')),
            ],
            options={
                'verbose_name': 'Personal user data',
                'verbose_name_plural': 'Personal users data',
                'ordering': ['date_birth'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_authenticate_date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_fk_auth_data', to=settings.AUTH_USER_MODEL)),
                ('user_personal_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_fk_personal_data', to='blog_auth.PersonalUsersData')),
            ],
            options={
                'verbose_name': 'User',
